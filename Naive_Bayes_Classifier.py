...
class Naive_Bayes_Classifier():
    ...
    def process_basic(self, fname):
       ...
       #test_doc       = 'Loved the casting of Jimmy Buffet as the science teacher'
       #test_doc       = 'Saw the movie today and thought it was a bad effort, good messages for kids'
...
if __name__ == '__main__':
   ...
   fname = '../input_data/sentiment_labelled_sentences/imdb_labelled.txt' 
